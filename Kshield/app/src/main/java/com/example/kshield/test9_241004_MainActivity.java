...
public class test9_241004_MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        box1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(test9_241004_MainActivity.this, subpage1.class);
        ...
        box2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(test9_241004_MainActivity.this, subpage2.class);
                startActivity(intent);
            }
        });
        ...
        //    @Override
        //    public void onClick(View v) {
        //        Intent intent = new Intent(test9_241004_MainActivity.this, subpage3.class);
        //        startActivity(intent);
        //    }
        //});
