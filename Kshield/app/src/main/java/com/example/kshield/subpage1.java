    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 1; i <= 3; i++) {
            ...
            levelButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    // Start LevelActivity with the selected level and subpage 1
                    Intent intent = new Intent(subpage1.this, LevelActivity.class);
                    intent.putExtra("level", level);
                    intent.putExtra("subpage", 1);  // subpage 1 전달
