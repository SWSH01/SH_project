        ...
        try {
            for (int i = 0; i < problemsArray.length(); i++) {
                ...
                FrameLayout.LayoutParams imageParams = new FrameLayout.LayoutParams(
                        200, 200);  // 이미지 크기 설정
                imageParams.gravity = Gravity.END | Gravity.CENTER_VERTICAL;  // 오른쪽 중앙에 배치
                ...
                frameLayout.addView(choicesGroup);  // RadioGroup 추가
        ...
        try {
            ...
            for (int i = 0; i < questionContainer.getChildCount(); i++) {
                ...
                if (child instanceof FrameLayout) {
                    ...
                    RadioGroup choicesGroup = (RadioGroup) frameLayout.getChildAt(1);  // RadioGroup이 두 번째로 들어가 있음
